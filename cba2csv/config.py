...
VENUES_INFO = {
    ...
    "Coburg HS": (
        ...
        "101 Urquhart Street, Coburg",
        "Access is via 101 Urquhart St, behind East Coburg Tennis Club.",
    ),
    "Coburg Senior High": "Coburg HS",
    "PVGC": (
        "Pascoe Vale Girls College",
        "Lake Avenue, Pascoe Vale",
        "Access is via Cornwall Rd, Pascoe Vale. Car park is near school crossing. The College Gym is to the right off car park.",
    ),
    "PVG": "PVGC",
    "Pascoe Vale Girls College": "PVGC",
    "Johns": (
        "St. John's Greek Orthodox College",
        "21 Railway Place, West Preston",
        "Entrance to gym & car park (Blanch St, Preston) is via Bell Street.",
    ),
    ...
    "Northcote High": (
        ...
        "19–25 St Georges Road, Northcote",
        None,
    ),
